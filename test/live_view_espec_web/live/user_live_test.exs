defmodule LiveViewEspecWeb.UserLiveTest do
  use LiveViewEspecWeb.ConnCase

  import Phoenix.LiveViewTest
  import LiveViewEspec.AccountsFixtures
  ...
  describe "Show" do
    ...
    test "updates user within modal", %{conn: conn, user: user} do
      {:ok, show_live, _html} = live(conn, Routes.user_show_path(conn, :edit, user))

      assert show_live |> element("a", "Edit") |> render_click() =~
               "Edit User"

      assert_patch(show_live, Routes.user_index_path(conn, :edit, user))
